...
# miami.musicians << User.create(first_name: "Erica", last_name: "Smith", bio: "classically trained", age: 31 )
#
...
#
# gig1 = Gig.create(name: "Electro Funk", location: "The Wicked Pickle", date: "2018-01-23", start_time: "22:00")
